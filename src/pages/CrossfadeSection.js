  ...
  return (
    <div className="crossfade-bg-section">
      ...
      <div className="crossfade-content understand-content" style={{ opacity: fade }}>
        <h2 style={{textAlign: 'left'}}>Start your journey to financial freedom</h2>
        <p>
          Millions of people will begin to rely on Lumeo to empower their financial lives by playing the money game.
        </p>
