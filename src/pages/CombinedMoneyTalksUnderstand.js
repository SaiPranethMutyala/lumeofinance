        ...
        >
          ...
          <div className="understand-overlay" style={{position:'relative',zIndex:2,display:'flex',width:'100%',height:'100%',alignItems:'center',justifyContent:'space-between',padding:'0 80px'}}>
            <div className="understand-left">
              ...
              <p className="understand-desc">Millions of people will rely on Lumeo to reshape how they build wealth — through gamified saving, personalized AI, and the social money game that makes finance feel fun again.</p>
