      ...
      <div className="team-grid">
        {teamMembers.map((member, index) => (
          <div className="team-member-card animate-on-scroll fade-in-up" key={index}>
            {member.name === 'Jake Lenef' && (
              <img src="/images/jake.jpg" alt="Jake Lenef" className="profile-photo-zoomed" />
            )}
            {member.name === 'Eric Bell' && (
              <img src="/images/eric.jpg" alt="Eric Bell" className="profile-photo-zoomed" />
            )}
            {member.name !== 'Jake Lenef' && member.name !== 'Eric Bell' && (
